...
export default function DashboardPage() {
  ...
  const pieChartData = {
    labels: stats?.processesByStatus?.map(status => translateProcessStatus(status.label)) || [],
    datasets: [{
        ...
        <div className="bg-white  rounded-xl p-6 shadow-sm">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">Bem-vindo ao seu painel de controle, {operator?.name}</p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-sm">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h3 className="font-semibold text-gray-800 dark:text-gray-200">Distribuição de Status</h3>
            </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-sm">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h3 className="font-semibold text-gray-800 dark:text-gray-200">Tipos de Processo</h3>
            </div>
            <div className="h-[300px]">
              <Bar
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-sm">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h3 className="font-semibold text-gray-800 dark:text-gray-200">Distribuição por Prioridade</h3>
            </div>
            <div className="h-[300px]">
              <Doughnut
                data={priorityData}
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-sm">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h3 className="font-semibold text-gray-800 dark:text-gray-200">Status dos Documentos</h3>
            </div>
            <div className="h-[300px]">
              <Bar
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card className="shadow-sm hover:shadow-md transition-all dark:bg-gray-900 ">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle className="text-xl font-semibold">Origem dos Processos</CardTitle>
              ...
              <CardContent className="p-6">
                <div className="h-[300px]">
                  <Doughnut data={stats.sourceDistribution} options={{
                    responsive: true,
                    maintainAspectRatio: false,
                    plugins: {
                      legend: {
            ...
            <Card className="shadow-sm hover:shadow-md transition-all dark:bg-gray-900 ">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle className="text-xl font-semibold">Performance dos Operadores</CardTitle>
              ...
              <CardContent className="p-6">
                <div className="h-[300px]">
                  <Bar data={stats.operatorPerformance} options={{
                    responsive: true,
                    maintainAspectRatio: false,
                    plugins: {
                      legend: {
              ...
              <CardContent className="p-6">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-end gap-2">
                    <span className="text-3xl font-bold text-gray-800">{stats.averageProcessTime.toFixed(1)}</span>
            ...
            <Card className="shadow-sm hover:shadow-md transition-all dark:bg-gray-900 ">
              <CardContent className="p-6">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-end gap-2">
                    <span className="text-3xl font-bold text-gray-800">{stats.processesPerOperator.toFixed(1)}</span>
                  </div>
                  <Progress value={75} className="h-2" />
                  <span className="text-sm text-gray-500">Meta: 15 processos</span>
                </div>
              </CardContent>
            </Card>
          </div>
