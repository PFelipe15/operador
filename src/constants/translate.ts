...
export const processStatusColors: Record<string, string> = {
    ...
    PENDING_DOCS: "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/50 dark:text-yellow-300",
    PENDING_COMPANY: "bg-orange-100 text-orange-800 dark:bg-stone-900/50 dark:text-stone-300",
    PENDING_DATA: "bg-orange-300 text-orange-800 dark:bg-orange-900/50 dark:text-orange-300",
    IN_ANALYSIS: "bg-blue-100 text-blue-800 dark:bg-blue-900/50 dark:text-blue-300",
    DOCS_SENT: "bg-purple-100 text-purple-800 dark:bg-purple-900/50 dark:text-purple-300",
    UNDER_REVIEW: "bg-orange-100 text-orange-800 dark:bg-orange-900/50 dark:text-orange-300",
